...
namespace MacroGuards
{
    ...
    public static class Guard
    {
        ...
        /// </exception>
        ///
        public static void Required([ValidatedNotNull] string value, string paramName)
        {
        ...
        /// </exception>
        ///
        public static T NotNull<T>([ValidatedNotNull] T value, string paramName)
        {
        ...
        /// </exception>
        ///
        public static void NotWhiteSpaceOnly(string value, string paramName)
        {
            CheckParamName(paramName);
            if (value == null)
                return;
        ...
        /// </exception>
        ///
        public static void ContainsNoWhiteSpace(string value, string paramName)
        {
            CheckParamName(paramName);
            if (value == null)
                return;
        ...
        static void CheckParamName(string paramName)
        {
            if (paramName == null)
